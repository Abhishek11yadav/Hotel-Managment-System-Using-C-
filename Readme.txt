...
Also, this program is considered as a simple database of hotel room booking where the user can store bookings’ records easily as it is not 
time-consuming. 
Moreover, users can also book convention hall and restaurant meal. Also, this project is easy to operate and understood by the users.